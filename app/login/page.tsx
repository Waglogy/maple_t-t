            ...
            {!isLogin && (
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" name="fullName" value={formData.fullName} onChange={handleChange} className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg" placeholder="John Doe" required={!isLogin} />
                </div>
              </div>
            )}
